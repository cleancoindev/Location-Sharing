...
public class PhoneNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(PhoneNumber.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//                Toast.makeText(PhoneNumber.this,phoneNum+"",Toast.LENGTH_SHORT).show();
                ...
                mDatabaseUser.child(Globalshare.uid).child("mob").setValue(phoneNum+"");
                mDatabaseLocationUser.child(Globalshare.uid).child("mob").setValue(phoneNum+"");

                Toast.makeText(PhoneNumber.this,"Hi You logged in ",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(PhoneNumber.this,setpassword.class);
